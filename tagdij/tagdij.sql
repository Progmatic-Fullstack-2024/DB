CREATE TABLE ugyfel (
    ...
    szulev SMALLINT NOT NULL,
    irszam SMALLINT NOT NULL,
    orsz CHAR(3) NOT NULL
);
...
CREATE TABLE befiz (
    ...
    osszeg INT NOT NULL,
    FOREIGN KEY (azon) REFERENCES ugyfel(azon)
);

INSERT INTO befiz VALUES (1001, '2016-01-11 16:25:03', 60000),
...
(1002, '2017-12-29 10:00:47', 18000),
(1002, '2018-12-29 10:00:47', 18000),
(1002, '2019-12-29 10:00:47', 18000),
(1002, '2020-12-29 10:00:47', 18000),
(1002, '2021-12-29 10:00:47', 18000),
(1002, '2022-12-29 10:00:47', 18000);